            ...
            for (let x = 0; x < toolbar.length; x++) {
                ...
                for (let y = 0; y < group.length; y++) {
                    ...
                    switch (name) {
                        ...
                        case "b":
                            // 生成加粗
                            createToolItem(groupBox, "<span style='font-weight:bold;'>B</span>", "b", function (e) {
                                if (typeof e === "undefined") e = {};
                                // 生成属性
                                let pros = "";
                                for (let key in e) pros += " " + key + "=\"" + e[key] + "\"";
                        ...
                        case "i":
                            // 生成斜体
                            createToolItem(groupBox, "<span style='font-style:italic;'>I</span>", "i", function (e) {
                                if (typeof e === "undefined") e = {};
                                // 生成属性
                                let pros = "";
                                for (let key in e) pros += " " + key + "=\"" + e[key] + "\"";
                        ...
                        case "s":
                            // 生成删除线
                            createToolItem(groupBox, "<span style='text-decoration:line-through;'>S</span>", "s", function (e) {
                                if (typeof e === "undefined") e = {};
                                // 生成属性
                                let pros = "";
                                for (let key in e) pros += " " + key + "=\"" + e[key] + "\"";
